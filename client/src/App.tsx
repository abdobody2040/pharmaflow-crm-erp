...
import RepAIWorkspace from "@/pages/RepAIWorkspace";
import Analytics from "@/pages/Analytics";
import BI from "@/pages/BI";
import ComplianceAdmin from "@/pages/ComplianceAdmin";
import OperationsExpansion from "@/pages/OperationsExpansion";
...
function Router() { return <Switch><Route path="/"><Framed><Overview /></Framed></Route><Route path="/operations"><Framed><OperationsExpansion /></Framed></Route><Route path="/inventory"><Framed><InventoryPage /></Framed></Route><Route path="/documents"><Framed><DocumentsPage /></Framed></Route><Route path="/integrations"><Framed><IntegrationsPage /></Framed></Route><Route path="/terminology"><Framed><TerminologyPage /></Framed></Route><Route path="/compliance"><Framed><ComplianceAdmin /></Framed></Route><Route path="/bi"><Framed><BI /></Framed></Route><Route path="/rep"><Framed><RepWorkspace /></Framed></Route><Route path="/rep/assistant"><Framed><RepAIWorkspace /></Framed></Route><Route path="/ai"><Framed><AIControlCenter /></Framed></Route><Route path="/analytics"><Framed><Analytics /></Framed></Route><Route path="/marketing"><Framed><MarketingPage /></Framed></Route><Route path="/routes"><Framed><RoutesPage /></Framed></Route><Route path="/hr"><Framed><HRPage /></Framed></Route><Route path="/tracking"><Framed><TrackingPage /></Framed></Route><Route path="/tenants"><Framed><TenantsPage /></Framed></Route><Route path="/crm/accounts/:id"><Framed><AccountDetail /></Framed></Route><Route path="/crm/accounts"><Framed><AccountsPage /></Framed></Route><Route path="/crm/contacts"><Framed><ContactsPage /></Framed></Route><Route path="/crm/plans"><Framed><PlansPage /></Framed></Route><Route path="/crm/territories"><Framed><TerritoryManager /></Framed></Route><Route path="/crm/cycles"><Framed><CyclePlanner /></Framed></Route><Route path="/crm/opportunities"><Framed><OpportunitiesPage /></Framed></Route><Route path="/visits/new"><Framed><VisitCapturePage /></Framed></Route><Route path="/directory"><Framed><DirectoryPage /></Framed></Route><Route path="/visits"><Framed><ComplianceRegistry kind="visits" /></Framed></Route><Route path="/samples"><Framed><ComplianceRegistry kind="samples" /></Framed></Route><Route path="/signatures"><Framed><ComplianceRegistry kind="signatures" /></Framed></Route><Route component={NotFound} /></Switch>; }
