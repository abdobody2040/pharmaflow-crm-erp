...
}, table => [index("procurement_requests_tenant_status_idx").on(table.tenantId, table.status), index("procurement_requests_tenant_created_idx").on(table.tenantId, table.createdAt)]);
