...
export type MobileSession = { shiftId: string; accessToken: string; apiBaseUrl: string; plannedStops: Array<{ latitude: number; longitude: number; accountName: string; accountId?: string; plannedVisitId?: string; sequence: number }> };
